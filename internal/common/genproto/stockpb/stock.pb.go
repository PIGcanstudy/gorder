...
import (
	...
	orderpb "github.com/PIGcanstudy/gorder/common/genproto/orderpb"
	reflect "reflect"
	sync "sync"
)
...
type GetItemsRequest struct {
	...
	ItemIDs []string `protobuf:"bytes,1,rep,name=ItemIDs,proto3" json:"ItemIDs,omitempty"` // 项目ID
}
...
type GetItemsResponse struct {
	...
	Items []*orderpb.Item `protobuf:"bytes,1,rep,name=Items,proto3" json:"Items,omitempty"` // 项目的相关信息
}
...
type CheckIfItemsInStockRequest struct {
	...
	Items []*orderpb.ItemWithQuantity `protobuf:"bytes,1,rep,name=Items,proto3" json:"Items,omitempty"` // 项目的数量
}
...
type CheckIfItemsInStockResponse struct {
	...
	InStock int32           `protobuf:"varint,1,opt,name=InStock,proto3" json:"InStock,omitempty"` // 有多少个库存
	Items   []*orderpb.Item `protobuf:"bytes,2,rep,name=Items,proto3" json:"Items,omitempty"`      // 库存里货物的具体信息
}
...
var file_stockpb_stock_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x70, 0x62, 0x1a, 0x13,
	...
	0x65, 0x6d, 0x73, 0x12, 0x18, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x47, 0x65,
	0x74, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x73,
	...
	0x23, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49,
	0x66, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x49, 0x6e, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x43,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x50, 0x49, 0x47, 0x63, 0x61, 0x6e, 0x73,
	0x74, 0x75, 0x64, 0x79, 0x2f, 0x67, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6d, 0x6d,
...
var file_stockpb_stock_proto_goTypes = []interface{}{
	(*GetItemsRequest)(nil),             // 0: orderpb.GetItemsRequest
	(*GetItemsResponse)(nil),            // 1: orderpb.GetItemsResponse
	(*CheckIfItemsInStockRequest)(nil),  // 2: orderpb.CheckIfItemsInStockRequest
	(*CheckIfItemsInStockResponse)(nil), // 3: orderpb.CheckIfItemsInStockResponse
...
var file_stockpb_stock_proto_depIdxs = []int32{
	4, // 0: orderpb.GetItemsResponse.Items:type_name -> orderpb.Item
	5, // 1: orderpb.CheckIfItemsInStockRequest.Items:type_name -> orderpb.ItemWithQuantity
	4, // 2: orderpb.CheckIfItemsInStockResponse.Items:type_name -> orderpb.Item
	0, // 3: orderpb.StockService.GetItems:input_type -> orderpb.GetItemsRequest
	2, // 4: orderpb.StockService.CheckIfItemsInStock:input_type -> orderpb.CheckIfItemsInStockRequest
	1, // 5: orderpb.StockService.GetItems:output_type -> orderpb.GetItemsResponse
	3, // 6: orderpb.StockService.CheckIfItemsInStock:output_type -> orderpb.CheckIfItemsInStockResponse
