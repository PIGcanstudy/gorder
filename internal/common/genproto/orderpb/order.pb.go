...
type CreateOrderRequest struct {
	...
	CustomerID string              `protobuf:"bytes,1,opt,name=CustomerID,proto3" json:"CustomerID,omitempty"` // 谁申请订单
	Items      []*ItemWithQuantity `protobuf:"bytes,2,rep,name=Items,proto3" json:"Items,omitempty"`           // 申请的订单内容
}
...
type ItemWithQuantity struct {
	...
	ID       string `protobuf:"bytes,1,opt,name=ID,proto3" json:"ID,omitempty"`              // 项目的ID
	Quantity int32  `protobuf:"varint,2,opt,name=Quantity,proto3" json:"Quantity,omitempty"` // 项目的数量
}
...
type GetOrderRequest struct {
	...
	OrderID    string `protobuf:"bytes,1,opt,name=OrderID,proto3" json:"OrderID,omitempty"`       // 项目的ID
	CustomerID string `protobuf:"bytes,2,opt,name=CustomerID,proto3" json:"CustomerID,omitempty"` // 是谁请求的
}
...
type Item struct {
	...
	PriceID  string `protobuf:"bytes,4,opt,name=PriceID,proto3" json:"PriceID,omitempty"` // 与价格对应
}
...
type Order struct {
	...
	ID          string  `protobuf:"bytes,1,opt,name=ID,proto3" json:"ID,omitempty"`
	CustomeID   string  `protobuf:"bytes,2,opt,name=CustomeID,proto3" json:"CustomeID,omitempty"`
	Status      string  `protobuf:"bytes,3,opt,name=Status,proto3" json:"Status,omitempty"`           // 订单的状态
	Items       []*Item `protobuf:"bytes,4,rep,name=Items,proto3" json:"Items,omitempty"`             // 订单的内容
	PaymentLink string  `protobuf:"bytes,5,opt,name=PaymentLink,proto3" json:"PaymentLink,omitempty"` // 支付连接
}
...
func (x *Order) GetCustomeID() string {
	if x != nil {
		return x.CustomeID
	}
	return ""
...
var file_orderpb_order_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x22, 0x4b, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65,
	...
	0x44, 0x22, 0x94, 0x01, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x49,
	0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x49, 0x44, 0x12, 0x1c, 0x0a, 0x09, 0x43,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x49, 0x44, 0x12, 0x16, 0x0a, 0x06, 0x53, 0x74, 0x61,
	...
	0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e,
	0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x50, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x32, 0xbf, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x64,
	...
	0x08, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x18, 0x2e, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x12, 0x35, 0x0a, 0x0b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x12, 0x0e, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x4f, 0x72, 0x64,
