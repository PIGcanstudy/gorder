module github.com/PIGcanstudy/gorder/common

go 1.23.5

replace github.com/PIGcanstudy/gorder/order => ../order

require (
	github.com/PIGcanstudy/gorder/order v0.0.0-00010101000000-000000000000
